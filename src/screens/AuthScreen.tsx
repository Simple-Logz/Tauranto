...
const styles = StyleSheet.create({
  ...
  formCard: { backgroundColor: colors.paper, borderRadius: 24, padding: 20, borderWidth: 1, borderColor: colors.line, ...shadow }, formTitle: { fontFamily: "NunitoSans_900Black", fontSize: 22, color: colors.ink, marginBottom: 20 },
